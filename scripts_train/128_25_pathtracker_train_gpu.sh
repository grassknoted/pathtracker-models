...
#SBATCH -o PTO_128_25_9_32dim_2000epochs_180bs_3e-4.out
#SBATCH -e PTO_128_25_9_32dim_2000epochs_180bs_3e-4.err
...
python -u ../mainclean.py --print-freq 20 --lr 3e-4 --epochs 2000 -b 180 --model ffhgru --name int_128_25_occ_9 --log --parallel --length 128 --thickness 9 --dist 25
