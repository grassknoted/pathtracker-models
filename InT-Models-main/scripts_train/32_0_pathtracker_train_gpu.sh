...
#SBATCH -o PTO_32_0_1_32dim_2000epochs_180bs_3e-4.out
#SBATCH -e PTO_32_0_1_32dim_2000epochs_180bs_3e-4.err
...
python -u ../mainclean.py --print-freq 20 --lr 3e-4 --epochs 2000 -b 180 --model ffhgru --name int_32_0_occ_1 --log --parallel --length 32 --thickness 1 --dist 0
